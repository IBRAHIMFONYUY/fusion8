        ...
        <Card className="flex flex-col border border-border bg-background/50">
          ...
          <CardContent className="flex-1 pt-8 space-y-6">
            <p className="text-sm text-muted-foreground leading-relaxed">
              The Onsite Accelerator is a 12-week intensive engineering boot camp in our Yaoundé labs. For those ready to commit 100% to building real hardware and complex software.
            </p>
