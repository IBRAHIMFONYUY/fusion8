...
import { Star, Clock, Loader2, AlertCircle, PlayCircle, Lock } from 'lucide-react';
...
export default function CourseDetailPage() {
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex items-center justify-center p-4">
          <Alert variant="destructive" className="max-w-md">
            ...
            <Button variant="outline" className="mt-4 w-full" onClick={() => router.push('/courses')}>
              Back to Catalog
            </Button>
          </Alert>
        </main>
  ...
  const handleEnrollClick = () => {
    if (!user) {
      // Synchronize flow: Redirect to subscribe with course ID so they return here
              ...
              <Card className="sticky top-24 shadow-xl overflow-hidden border-none">
                 ...
                 <CardContent className="p-6">
                    <div className="flex justify-between items-center mb-4">
                        <span className="text-2xl font-bold">{(course.price || 50000).toLocaleString()} XAF</span>
