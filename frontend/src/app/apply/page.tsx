    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 border-b border-white/[0.06] overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-base md:text-lg max-w-xl mx-auto mb-4" style={{ color: 'rgba(246,245,242,0.55)' }}>
      ...
      <section className="bg-[#070A0C] border-b border-white/[0.06]">
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {STEPS.map((s, i) => (
              <div key={s.n} className={`relative bg-card border rounded-2xl p-6 hover:border-accent/25 transition-all ${i === 0 ? 'border-accent/25 bg-accent/[0.04]' : 'border-white/[0.07]'}`}>
                <div className="text-5xl font-black font-mono mb-3 leading-none" style={{ color: i === 0 ? 'rgba(228,77,40,0.35)' : 'rgba(246,245,242,0.08)' }}>{s.n}</div>
                <h3 className={`text-sm font-black mb-1.5 ${i === 0 ? 'text-accent' : 'text-foreground'}`}>{s.t}</h3>
                <p className="text-xs leading-relaxed" style={{ color: 'rgba(246,245,242,0.50)' }}>{s.d}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-card border border-accent/20 rounded-2xl overflow-hidden">
                <div className="p-6 border-b border-white/[0.07]">
                  ...
                  <p className="text-sm mt-1" style={{ color: 'rgba(246,245,242,0.50)' }}>Takes about 5 minutes. Tell us who you are and why you want to build.</p>
                </div>
                <div className="p-6">
                  <Button asChild size="lg" className="w-full bg-accent hover:bg-orange-600 text-white font-black h-13 rounded-xl shadow-lg shadow-accent/25">
              ...
              {/* WhatsApp */}
              <div className="bg-card border border-white/[0.07] hover:border-accent/15 rounded-2xl overflow-hidden transition-all">
                <div className="p-6 border-b border-white/[0.07]">
                  ...
                  <p className="text-sm mt-1" style={{ color: 'rgba(246,245,242,0.50)' }}>After payment confirmation, join the cohort WhatsApp group.</p>
                </div>
                <div className="p-6">
                  <Button asChild size="lg" variant="outline" className="w-full border-white/20 text-foreground hover:bg-white/5 h-13 rounded-xl font-bold">
            ...
            <div className="space-y-5">
              <div className="bg-card border border-white/[0.07] rounded-2xl overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  <div className="bg-background border border-accent/15 rounded-xl p-5">
                    <p className="text-[10px] font-black uppercase tracking-widest mb-3" style={{ color: 'rgba(246,245,242,0.40)' }}>MTN Mobile Money</p>
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="text-xs" style={{ color: 'rgba(246,245,242,0.55)' }}>Number</span>
                        <span className="text-base font-black font-mono text-foreground">680 149 883</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs" style={{ color: 'rgba(246,245,242,0.55)' }}>Name</span>
                        <span className="text-sm font-bold text-foreground">Jones Yondo</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs" style={{ color: 'rgba(246,245,242,0.55)' }}>Amount</span>
                        <span className="text-2xl font-black text-accent">5,000 XAF</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs" style={{ color: 'rgba(246,245,242,0.55)' }}>Reference</span>
                  ...
                  <div className="bg-accent/[0.06] border border-accent/15 rounded-xl p-4">
                    <p className="text-xs leading-relaxed" style={{ color: 'rgba(246,245,242,0.65)' }}>
              ...
              <div className="bg-card border border-white/[0.07] rounded-2xl p-6">
                <p className="text-[10px] font-black uppercase tracking-widest mb-4" style={{ color: 'rgba(246,245,242,0.38)' }}>Questions? Contact Us</p>
                <div className="space-y-3">
                  <a href="tel:+237680149883" className="flex items-center gap-3 text-sm hover:text-white transition-colors" style={{ color: 'rgba(246,245,242,0.60)' }}>
                    <Phone className="h-4 w-4 text-accent shrink-0" />+237 680 149 883
                  </a>
                  <a href="mailto:fusion8.cohort01@gmail.com" className="flex items-center gap-3 text-sm hover:text-white transition-colors" style={{ color: 'rgba(246,245,242,0.60)' }}>
                    <Mail className="h-4 w-4 text-accent shrink-0" />fusion8.cohort01@gmail.com
                  </a>
                  <div className="flex items-center gap-3 text-sm" style={{ color: 'rgba(246,245,242,0.60)' }}>
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            <div>
              ...
              <ul className="space-y-3">
                {REQUIREMENTS.map(r => (
                  <li key={r} className="flex items-start gap-3 text-sm" style={{ color: 'rgba(246,245,242,0.68)' }}>
