...
export default function TeacherNotificationsPage() {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'NEW_LESSON':
      case 'COURSE_UPDATE': return <Rocket className="h-5 w-5 text-primary" />;
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-black font-headline tracking-tighter uppercase">Notifications</h1>
        ...
        <CardHeader className="bg-secondary/30 border-b border-dashed">
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>Student submissions, questions, and platform updates.</CardDescription>
            </div>
          ...
          {notifications && notifications.length > 0 ? (
            ...
            <div className="p-12">
              <EmptyState
                icon={Bell}
                title="Quiet center"
                description="Your notification feed is currently clear. You'll be alerted here about student submissions and platform updates."
              />
            </div>
          )}
        </CardContent>
